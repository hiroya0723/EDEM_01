...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/edem_01.exe
...
${OBJECTDIR}/ConstModule.o: ConstModule.f90
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/ConstModule.o ConstModule.f90

${OBJECTDIR}/DEMModule.o: DEMModule.f90
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/DEMModule.o DEMModule.f90

${OBJECTDIR}/MethodModule.o: MethodModule.f90
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/MethodModule.o MethodModule.f90
